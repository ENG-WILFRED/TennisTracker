      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: "1.2rem", marginTop: "1.5rem" }}>
            ...
            <button 
              ...
              style={{
                ...
                background: G.card2, border: `1px solid ${G.border}`, borderRadius: 8,
                fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 500,
                color: G.text2, cursor: "pointer", display: "flex",
                alignItems: "center", justifyContent: "center", gap: 8,
                transition: "border-color 0.2s",
              }}
              onMouseEnter={(e) => e.currentTarget.style.borderColor = G.muted2}
