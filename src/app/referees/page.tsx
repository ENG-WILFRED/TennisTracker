...
import { Gavel, Award, Users, Globe, TrendingUp, ArrowLeft, Star, Trophy, Shield } from 'lucide-react';
    ...
    <main className="min-h-screen bg-gradient-to-br from-pink-100 via-pink-50 to-fuchsia-100 relative overflow-hidden">
      ...
      <div className="relative w-full mx-auto py-12 px-4">
        ...
        <div className="mb-12">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 text-pink-700 hover:text-pink-900 mb-6 font-bold transition-colors bg-white/70 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm hover:shadow-md"
          >
            ...
            {filteredReferees.map((referee) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Action Button */}
                  <button className="w-full bg-gradient-to-r from-pink-500 via-fuchsia-500 to-pink-600 hover:from-pink-600 hover:via-fuchsia-600 hover:to-pink-700 text-white font-black py-4 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-2xl transform hover:scale-105 border-2 border-pink-400">
                    View Full Profile
                  </button>
                </div>
              </div>
