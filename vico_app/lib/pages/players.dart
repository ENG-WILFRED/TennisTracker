          ...
          builder: (context, snapshot) {
            ...
            final display = _search.isNotEmpty
                ? players.where((p) {
                    ...
                    return name.contains(_search.toLowerCase()) || username.contains(_search.toLowerCase());
                  }).toList()
                : players;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text('$level level', style: TextStyle(fontSize: 12, color: Colors.grey[500]), maxLines: 1, overflow: TextOverflow.ellipsis),
                        ],
                      ),
                    ),
                  ],
